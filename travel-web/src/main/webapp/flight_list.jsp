			...
			<div class="flight-list-view">
				...
				<div class="col-md-6 col-sm-6 col-xs-8 text-center clear-padding flight-desc">
					<div class="take-off">
						...
						<h5><i class="fa fa-map-marker"></i> <%=f.getDestAirport().getCity()%> (<%=f.getDestAirport().getIata()%>), <%=f.getSourceAirport().getCity()%> (<%=f.getSourceAirport().getIata()%>)</h5>
					</div>
					<div class="landing">
						<h4><i class="fa fa-plane fa-rotate-90"></i> <%=f.getArrival()%> Mon, Aug 3</h4> 
						<h5><i class="fa fa-map-marker"></i> <%=f.getSourceAirport().getCity()%> (<%=f.getSourceAirport().getIata()%>), <%=f.getDestAirport().getCity()%> (<%=f.getDestAirport().getIata()%>)</h5>
					</div>
				</div>
